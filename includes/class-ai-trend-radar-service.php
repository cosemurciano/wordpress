...
class ALMA_AI_Trend_Radar_Service {
    ...
    private static function call_openai($profile, $affiliate_context) {
        ...
        $res = ALMA_OpenAI_Service::request(array('system_prompt'=>$system,'user_prompt'=>$prompt,'json_output'=>true,'response_format'=>$schema,'max_output_tokens'=>3500,'timeout'=>60,'tools'=>array(array('type'=>'web_search'))));
