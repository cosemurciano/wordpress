...
class ALMA_Trend_Content_Ideas_Admin {
    ...
    private static function render_settings() {
        ...
        $model = get_option(ALMA_Trend_Content_Ideas_Store::OPTION_MODEL, ''); $timeout = get_option(ALMA_Trend_Content_Ideas_Store::OPTION_TIMEOUT, 90); $global_model = get_option('alma_openai_model', ''); $effective_model = ALMA_Trend_Content_Ideas_Service::effective_model();
