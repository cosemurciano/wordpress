...
class ALMA_Trend_Content_Ideas_Admin {
    ...
    private static function render_settings() {
        ...
        $model = $model_details['trend_model_saved']; $timeout = get_option(ALMA_Trend_Content_Ideas_Store::OPTION_TIMEOUT, 90); $global_model = $model_details['global_model']; $effective_model = $model_details['effective_model'];
