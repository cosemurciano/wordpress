...
class ALMA_AI_Idea_Agent {
    ...
    private static function tool_definitions() {
        ...
        return array_merge($tools, array(
            ...
            array('type' => 'function', 'name' => 'scheda_localita', 'description' => 'Scheda di una località dell\'indice geografico del sito: CLIMA reale (mesi migliori per visitare, mesi da evitare, temperature e piogge mensili da Open-Meteo) più dati interni (link affiliati e articoli già esistenti sulla zona). Usala prima di proporre un\'idea su una destinazione per scegliere il taglio stagionale giusto.', 'parameters' => array('type' => 'object', 'properties' => array('localita' => array('type' => 'string', 'description' => 'Nome della località (es. "Lisbona")')), 'required' => array('localita'), 'additionalProperties' => false)),
