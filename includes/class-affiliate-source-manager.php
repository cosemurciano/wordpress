...
class ALMA_Affiliate_Source_Manager {
    ...
    private function render_gyg_csv_import_type_report($report, $back_url, $self_url, $list_url) {
        ...
        $labels = array('imported'=>'Record importati','updated'=>'Record aggiornati','titles_populated'=>'Titoli popolati da Titolo Attività','titles_missing'=>'Record senza Titolo Attività','ai_contexts_populated'=>'Contesti AI popolati','ai_contexts_missing'=>'Contesti AI non popolati','link_types_associated'=>'Tipologie Link associate','existing'=>'Già presenti','skipped'=>'Saltati','errors'=>'Errori','invalid_urls'=>'URL non validi','without_city'=>'Record senza città','without_region'=>'Record senza regione','requested'=>'Quantità richiesta','processed'=>'Quantità effettivamente processata');
    ...
    private function handle_gyg_csv_import_type() {
        ...
        $aggregate = array('requested'=>$quantity,'processed'=>0,'imported'=>0,'updated'=>0,'existing'=>0,'skipped'=>0,'errors'=>0,'invalid_urls'=>0,'without_city'=>0,'without_region'=>0,'titles_populated'=>0,'titles_missing'=>0,'ai_contexts_populated'=>0,'ai_contexts_missing'=>0,'link_types_associated'=>0,'duration'=>0,'logs'=>array(),'next_cursor'=>$cursor,'done'=>false);
        do {
            ...
            foreach (array('processed','imported','updated','existing','skipped','errors','invalid_urls','without_city','without_region','titles_populated','titles_missing','ai_contexts_populated','ai_contexts_missing','link_types_associated') as $k) $aggregate[$k] += absint($batch[$k] ?? 0);
