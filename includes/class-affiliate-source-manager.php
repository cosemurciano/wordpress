...
class ALMA_Affiliate_Source_Manager {
    ...
    private function render_import_contents_page(){
        ...
        if($load_preview){
            $criteria_service=new ALMA_Affiliate_Source_Import_Criteria_Service(); $criteria=$criteria_service->sanitize($_GET); $preview_service=new ALMA_Affiliate_Source_Import_Preview_Service(); $items=$preview_service->get_preview_items($source,$criteria);
